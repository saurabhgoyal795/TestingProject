...
public class BluetoothService {
    ...
    private synchronized void setState(int state) {
        ...
        mHandler.obtainMessage(BluetoothMainActivity.MESSAGE_STATE_CHANGE, state, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(BluetoothMainActivity.MESSAGE_DEVICE_NAME);
    ...
    private void connectionFailed() {
        ...
        Message msg = mHandler.obtainMessage(BluetoothMainActivity.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
            ...
            while (true) {
                try {
                    ...
                    if(bytes>0)
                    {
	                    ...
	                    mHandler.obtainMessage(BluetoothMainActivity.MESSAGE_READ, bytes, -1, buffer)
	                            .sendToTarget();
                    }
                    else
                    {
        ...
        public void write(byte[] buffer) {
            try {
               ...
               /* if (buffer.length > 3000) //
                ...
                mHandler.obtainMessage(BluetoothMainActivity.MESSAGE_WRITE, -1, -1, buffer)
                        .sendToTarget();
            } catch (IOException e) {
