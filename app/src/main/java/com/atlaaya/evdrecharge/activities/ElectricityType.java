...
import com.atlaaya.evdrecharge.databinding.ActivityElectricityTypeBinding;
...
public class ElectricityType extends BaseActivity implements View.OnClickListener, CalculateElectricityListner {

    private ActivityElectricityTypeBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_electricity_type);
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            try {
                ...
                if(isStatus){
                    ...
                    JSONObject responseMsg = jsonObject.getJSONObject("RESPONSE_MSG");
                    String responseString = responseMsg.getString("message");
                    MyCustomToast.showErrorAlert(ElectricityType.this, responseString);
                }
