...
public class AddBankAccountPresenter extends BasePresenter<AddBankAccountListener> {

    public void bankAccountAddEdit(final Context context, final HashMap<String, RequestBody> requestBody) {

        getView().enableLoadingBar(context, true, context.getString(R.string.txt_please_wait));

        MyApplication.getInstance().getAPIInterface().bankAccountAddEdit(requestBody)
