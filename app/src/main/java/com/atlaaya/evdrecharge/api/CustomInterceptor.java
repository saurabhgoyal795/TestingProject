...
import com.atlaaya.evdrecharge.utils.Logger;
...
//        Response response = chain.proceed(request);
        ...
        if (CheckInternetConnection.isInternetConnection(context)) {
    ...
    public interface Logger {
        Logger DEFAULT = message -> {
            ...
            com.atlaaya.evdrecharge.utils.Logger.error("Response", message);
        };
